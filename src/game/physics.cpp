...
void _moveplayer(dynent *pl, int moveres, bool local, int curtime)
{
...
{
	loopi(physicsrepeat) _moveplayer(pl, moveres, local, i ? curtime/physicsrepeat : curtime-curtime/physicsrepeat*(physicsrepeat-1));
};
