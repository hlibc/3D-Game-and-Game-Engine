...
typedef struct block { int x, y, xs, ys; }block;
...
typedef struct dynent						   // players & monsters
{
	...
	struct dynent *enemy;					  // monster wants to kill this entity
...
enum { CS_ALIVE = 0, CS_DEAD =0, CS_LAGGED = 0, CS_EDITING=0 };
...
typedef struct vertex { float u, v, x, y, z; uchar r, g, b, a; }vertex; 
...
#define COMMANDN(name, fun, nargs) bool __dummy_##fun = addcommand(#name, (void (*)())fun, nargs)
